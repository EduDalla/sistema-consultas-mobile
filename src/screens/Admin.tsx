...
export default function Admin({ navigation }: any) {
  ...
  function adicionarEspecialidade() {
    if (!nomeEsp || !descEsp) {
      Alert.alert("Erro", "Preencha nome e descricao");
      return;
    }
  ...
  function adicionarMedico() {
    ...
    setNomeMed("");
    setCrmMed("");
    Alert.alert("Sucesso", "Medico adicionado!");
  }
  ...
  async function criarConsultaTeste() {
    ...
    if (medicos.length === 0) {
      Alert.alert("Erro", "Adicione um medico primeiro!");
      return;
    }
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content}>
        ...
        {/* SECAO 2: MEDICOS */}
        <View style={styles.secao}>
          <Text style={styles.titulo}>2. Adicionar Medico</Text>
          <TextInput
            style={styles.input}
          ...
          />
          <Button title="Adicionar Medico" onPress={adicionarMedico} />
          <View style={styles.lista}>
            {medicos.map((med) => (
